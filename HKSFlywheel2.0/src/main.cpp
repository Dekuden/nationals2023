...
void intaketimer(int speed, int duration){
  intake1.spin(directionType::fwd,speed/12,voltageUnits::volt);
  task::sleep(duration);
...
void redmk1()
{
 rollerfwd(-50, -100, 800);
 vex::task::sleep(250);
 encfwd(2,25);
 vex::task::sleep(250);
 advturnleft(48.5, 50, 10);
 vex::task::sleep(250);
 advfwdWintake(7.4, 60, 10, 100);
 indexer.spin(vex::directionType::fwd,-12,voltageUnits::volt);
 intake(100);
 advrev(5, 40, 5);
 advturnright(117.6,50,10);
 vex::task::sleep(250);
 advfwdWintake(78, 60, 10, -100);
 advrev(12,50,10);
 advturnleft(118, 60,10);
 intake(100);
 vex::task::sleep(1200);
...
void bluemk1()
{
 rollerfwd(-100, -100, 1200);
 vex::task::sleep(250);
 encfwd(2,25);
 vex::task::sleep(250);
 advturnleft(48.5, 50, 10);
 vex::task::sleep(250);
 advfwdWintake(6.8, 60, 10, 100);
 indexer.spin(vex::directionType::fwd,-12,voltageUnits::volt);
 intake(100);
 advrev(7, 40, 5);
 advturnright(117.6,50,10);
...
void redmk2()
{
  advfwdWintake(23, 60, 10,-100);
  task::sleep(400);
  reset(-12,1000);
  task::sleep(400);
  advfwd(80,60,10);
  task::sleep(400);
  advturnright(55,60,10);
  task::sleep(400);
  advturnright(55,60,10);
  task::sleep(400);
  rollerfwd(50, -100, 800);
...
void userControl(void) {
  ...
  while (true) {
    ...
    {
      topfly.spin(directionType::fwd,11,voltageUnits::volt);
      botfly.spin(directionType::fwd,11,voltageUnits::volt);
    }
